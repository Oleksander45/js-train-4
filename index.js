...
function padString(original, length, padWith, side) {
  ...
  return side === `start`? original.padStart(length, padWith): side === `end`? original.padEnd(length, padWith): "Error: side should be either 'start' or 'end'";
}
...
function trimString(original, side) {
  ...
  return side === `start`? original.trimStart() : side === `end`? original.trimEnd() : side  === `both`? original.trim() : "Error: side should be either 'start', 'end' or 'both'";
}
...
function convertCase(original, caseType) {
  ...
  return caseType === `upper` ? original.toUpperCase() : caseType === `lower` ? original.toLowerCase() :"Error: caseType should be either 'upper' or 'lower'";
}
